...
class Defaults < ActiveRecord::Base
  ...
  BOTTLE = [128,186]
  CHARLIE = {
    'black'     => {o: 15..100, h: 0..360,   s: 0..100,  l: 0..8},
    'blue'      => {o: 15..100, h: 182..250, s: 30..100, l: 5..87},
    'brown'     => {o: 15..100, h: 24..35,   s: 33..100, l: 9..26},
    'coral'     => {o: 15..100, h: 10..20,   s: 80..100, l: 35..65},
    'gold'      => {o: 15..100, h: 44..50,   s: 6..75,   l: 75..90},
    'green'     => {o: 15..100, h: 61..151,  s: 20..100, l: 5..87},
    'grey'      => {o: 15..100, h: 0..360,   s: 0..10,   l: 22..76},
    'ivory'     => {o: 15..100, h: 56..64,   s: 80..100, l: 85..100},
    'mint'      => {o: 15..100, h: 125..151, s: 15..100, l: 55..85},
    'nude'      => {o: 15..100, h: 10..40,   s: 35..60,  l: 50..80},
    'pink'      => {o: 15..100, h: 348..353, s: 65..100, l: 65..95},
    'purple'    => {o: 15..100, h: 295..305, s: 75..100, l: 22..52},
    'red'       => {o: 15..100, h: 0..12,    s: 40..100, l: 5..78, h2: 331..360},
    'rose-gold' => {o: 15..100, h: 44..50,   s: 6..75,   l: 75..90},
    'silver'    => {o: 15..100, h: 0..360,   s: 0..30,   l: 50..90},
    'teal'      => {o: 15..100, h: 174..185, s: 70..100, l: 18..50},
    'turquoise' => {o: 15..100, h: 158..195, s: 30..100, l: 10..80},
    'white'     => {o: 15..100, h: 0..360,   s: 0..100,  l: 92..100},
    'yellow'    => {o: 15..100, h: 40..62,   s: 40..100, l: 5..78},
    'clear'     => {o: 00..15,  h: 0..360,   s: 0..100,  l: 0..100}
  }
  COLOURS = {
    en: {
      ...
      'orange'         => {h: 6..42,    s: 40..100, l: 5..78},
      'yellow'         => {h: 40..62,   s: 40..100, l: 5..78},
      ...
      'indigo'         => {h: 200..262, s: 20..100, l: 10..87},
      'violet'         => {h: 263..290, s: 20..100, l: 5..87},
      'magenta'        => {h: 285..330, s: 20..100, l: 5..87},
      ...
      'turquoise'      => {h: 158..195, s: 30..100, l: 10..80},
