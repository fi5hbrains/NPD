...
class Defaults < ActiveRecord::Base
  ...
  RESERVED_NAMES = %w(ads maintenance vote autocomplete note get_invite admin administrator application assets bottles boxes brands catalogue comments delete destroy diary edit entries images index invites javascripts lab login logout moderator new notes polishes search session stylesheets tags update user_session users)
  ...
  COLOURS = {
    en: {
      ...
      'tin'            => {h:0..1, s: 1..2, l: 2..3},
      'nickel'         => {h:0..1, s: 1..2, l: 2..3},
      'aluminium'      => {h:0..1, s: 1..2, l: 2..3},
      'magnesium'      => {h:0..1, s: 1..2, l: 2..3},
      'silver'         => {h:0..1, s: 1..2, l: 2..3},
      'mercury'        => {h:0..1, s: 1..2, l: 2..3},
      'cayenne'        => {h:0..1, s: 1..2, l: 2..3},
      'mocha'          => {h:0..1, s: 1..2, l: 2..3},
      'asparagus'      => {h:0..1, s: 1..2, l: 2..3},
      'eggplant'       => {h:0..1, s: 1..2, l: 2..3},
      'tangerine'      => {h:0..1, s: 1..2, l: 2..3},
      'lemon'          => {h:0..1, s: 1..2, l: 2..3},
      'blueberry'      => {h:0..1, s: 1..2, l: 2..3},
